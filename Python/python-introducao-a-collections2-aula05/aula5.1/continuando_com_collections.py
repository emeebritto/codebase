...
assistiram = usuarios_data_science.copy() # copy é função da list
assistiram.extend(usuarios_machine_learning) # extend() é uma finção da list
assistiram
...
set([1,2,3,1]) # cria conjunto, sem repetição
