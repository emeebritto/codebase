...
let corReflexoLateral = "rgb(107 107 107 / 88%)";
let corReflexoLateralCamada2 = "rgb(55 55 55 / 54%)";
let corReflexoSemiVertical = "rgb(75 75 75 / 84%)";

let blurReflexoLateral = "5px 5px 30px #7E7E7E";
let blurReflexoLateralCamada2 = "5px 5px 30px #7E7E7E";
let blurReflexoSemiVertical = "5px 5px 30px #7E7E7E";
...
for (var i = bordaInicialA; i <= bordaFinalD; i++){
	...
	botton.style.backgroundColor= "#070815";
...
configurar_Luz_e_Reflexo_Inicial();
...
document.addEventListener('keydown', function(){
	if (event.key == 'w' || event.key == 'W'){ verificarPosicaoW(); painelMap.textContent = ""; aud.play();}
...
function arualizar_parametros_persoMain() {
    ...
    // 1° Area de reflexo lateral - Nova Area
	positionReflexoW = positionPersoMain - 40;
	positionReflexoA = positionPersoMain - 2;
	positionReflexoS = positionPersoMain + 38;
	// 1° Area de reflexo - semi-verticais - Nova Area
	positionReflexoW1 = positionPersoMain - (bordaInicialD +2);
	positionReflexoS1 = positionPersoMain + (bordaInicialD);
	positionReflexoA1 = positionPersoMain + 37;
	positionReflexoD1 = positionPersoMain - 39;
    // 2° Area de reflexo lateral - Nova Area
	positionReflexoW2 = positionPersoMain - (bordaInicialD +40);
    positionReflexoS2 = positionPersoMain + (bordaInicialD +38);
    positionReflexoA2 = positionPersoMain - 3;
    positionReflexoD2 = positionPersoMain + 1;

    // 1° Area de reflexo - Apagando anterior
	positionLastReflexoW = lastPosition - 40;
	positionLastReflexoA = lastPosition - 2;
	positionLastReflexoS = lastPosition + 38;
	// 1° Area de reflexo - semi-verticais - Apagando anterior
	positionLastReflexoW1 = lastPosition - (bordaInicialD +2);
	positionLastReflexoS1 = lastPosition + (bordaInicialD);
	positionLastReflexoA1 = lastPosition + 37;
	positionLastReflexoD1 = lastPosition - 39;
	// 2° Area de reflexo - Apagando anterior
	positionLastReflexoW2 = lastPosition - (bordaInicialD +40);
	positionLastReflexoS2 = lastPosition + (bordaInicialD +38);
	positionLastReflexoA2 = lastPosition - 3;
	positionLastReflexoD2 = lastPosition + 1;
    // Restauração do bloco após o reflexo
    corRestauracao = "#070815";
    clearShadow = "";
}
